...
export const HistoryScreen: React.FC<HistoryScreenProps> = ({
  ...
  return (
    <div className="p-3 sm:p-4 space-y-4 max-w-lg mx-auto pb-8">
      {/* Header Banner */}
      <div className="bg-[#1F5D3B] text-white p-4 rounded-3xl shadow-sm space-y-3">
        <div className="flex items-center space-x-2.5">
          <div className="w-12 h-10 rounded-2xl bg-white/20 flex items-center justify-center text-2xl shrink-0">
            📋
          </div>
          <div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-1.5 bg-white text-[#1F5D3B] font-extrabold text-sm px-3 py-3 rounded-xl shadow min-h-[52px]"
        ...
        {scans.length > 0 && (
          <button
            ...
            className="w-full flex items-center justify-center space-x-1 bg-white/15 hover:bg-white/25 text-white font-bold text-sm px-3 py-3 rounded-xl min-h-[48px]"
      ...
      >
        <button
          ...
          className={`px-3.5 py-3 min-h-[48px] rounded-xl text-sm font-extrabold whitespace-nowrap transition-all border ${
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-center space-x-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h3 className="font-black text-base text-[#1A1A1A] dark:text-white truncate">
                        {displayName}
                      </h3>
                      <div className="flex items-center space-x-1 text-sm text-[#5A5243] dark:text-slate-400 mt-1">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-slate-100 dark:border-slate-700/60">
                  ...
                  <div
                    className={`inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl border font-black text-sm tracking-wide shadow-sm ${verdict.tagColor}`}
                  >
